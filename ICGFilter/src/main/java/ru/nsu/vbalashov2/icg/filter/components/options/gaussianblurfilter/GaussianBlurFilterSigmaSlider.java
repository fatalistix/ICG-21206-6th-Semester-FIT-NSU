...
public class GaussianBlurFilterSigmaSlider extends JSlider {

    public GaussianBlurFilterSigmaSlider(PublishSubject<Double> dynamicValueChangingPublishSubject) {
        super(1, 100, 10);
