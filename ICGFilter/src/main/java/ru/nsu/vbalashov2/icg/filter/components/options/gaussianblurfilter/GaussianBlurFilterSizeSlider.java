...
public class GaussianBlurFilterSizeSlider extends JSlider {

    public GaussianBlurFilterSizeSlider(PublishSubject<Integer> dynamicValueChangingPublishSubject) {
        super(1, 5, 1);
